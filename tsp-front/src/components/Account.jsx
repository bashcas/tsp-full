...
import { FaInfoCircle, FaTrash, FaSignOutAlt } from "react-icons/fa";

const Account = () => {
    const { local, setLoading, endpoint, url_paths, logout } = useContext(GlobalContext);
        ...
        <div className="account__container">
            ...
            <div className="account">
                ...
                <div className="account__options">
                    ...
                    <button className="option__logout" onClick={logout}>
                            <span className="icon">
                                <FaSignOutAlt />
                            </span>
